...
# 2. Custom CSS to hide the Streamlit toolbar (keep the sidebar button!)
st.markdown("""
<style>
...
app_mode = st.sidebar.selectbox(
    ...
    ["1. Radial System (Voltage Regulation)", "2. Multi-Bus Meshed (Example 5.9)"]
)
st.sidebar.markdown("---")
...
# =====================================================================
    ...
    st.markdown('<p class="sub-text">Solves per-unit values for multi-generator meshed systems</p>', unsafe_allow_html=True)
